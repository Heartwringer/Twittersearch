...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        queryEditText = ((EditText) findViewById(R.id.queryTextInputLayout));
        tagEditText = ((EditText) findViewById(R.id.tagTextInputLayout));
        ...
        //saveFloatingActionButton = (FloatingActionButton) findViewById(R.id.floatingActionButton);
